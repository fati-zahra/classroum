...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).language(DEFAULT_LANGUAGE);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.language(UPDATED_LANGUAGE);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).language(UPDATED_LANGUAGE);
