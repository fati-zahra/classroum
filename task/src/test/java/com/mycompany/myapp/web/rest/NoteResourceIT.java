...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return note;
    }
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return note;
    }
    ...
    void putNewNote() throws Exception {
        ...
        updatedNote.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
