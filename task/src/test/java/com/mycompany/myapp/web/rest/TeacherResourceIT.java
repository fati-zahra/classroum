...
class TeacherResourceIT {
    ...
    void putNewTeacher() throws Exception {
        ...
        updatedTeacher.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.firstName(UPDATED_FIRST_NAME).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
